...
public class DBgrid {
	...
	public static String createLayout(String interface_id, String child_id, Document doc, String height,
															 ...
															 */
		{
			...
			griddiv.setAttribute("style", "position:" + position + ";left :" + x + "; top:" + y + ";width:" + width + "; height:" + height + "px;"
					+ stylevalue);
