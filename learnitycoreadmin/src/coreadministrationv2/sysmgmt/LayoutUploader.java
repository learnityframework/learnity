...
public class LayoutUploader {
	...
	private static String uploadInterfaceCollection(String attachmentname, String s7, String typecollection, String fsize, HttpServletRequest request,
			HttpServletResponse response, String inlinecss, String inlinejs, String imagepath, String loggedInUserId, boolean isNew) {
					...
					for (int ma = 0; ma < interface1.getLength(); ma++) {
						...
						if (f1.exists()) {
							...
							if (childtype.equals(INTERFACE_TYPE)) {
								Pair<Boolean, String> interfaceStatus=uploadInterface(attachmentname, attachmentname + name + File.separator + name + File.separator, zip, childtype, childSize,
										request, response, inlinecss, inlinejs, imagepath, loggedInUserId, isNew);
							...
							if (childtype.equals(INTERFACE_FRAGMENT_TYPE)) {
								Pair<Boolean, String> interfaceStatus=uploadInterfaceFragment(attachmentname, attachmentname + name + File.separator + name + File.separator, zip, childtype,
	...
	public static Pair<Boolean,String> uploadInterface(String htmlgeneratepath, String attachmentname, String s7, String typecollection, String fsize,
						...
						for (int s = 0; s < structure.getLength(); s++) {
							...
							for (int d = 0; d < part.getLength(); d++) {
								...
								for (int el = 0; el < elementitem.getLength(); el++) {
									...
									DataBaseLayer.InsertDBFormElement(interface_id, part_id, element_id, element_class, element_type, element_key, tabindex,
											selectindex, modifyindex, insertindex, rows, cols, forlabel, required, minlength, maxlength, equalto, number,
											email, requiredmess, minlengthmess, maxlengthmess, equaltomess, numbermess, emailmess, element_size);
								}
								...
								for (int u = 0; u < selectoritem.getLength(); u++) {
									...
									// FOR DROPDOWN
									// END//////////////////////////////////////////////////////
									DataBaseLayer.addSelecetor(interface_id, selector_id, selector_class, domaintype, value, gridrefresh, influence, part_id,
											contentid, behaviourid, show_choose_one, choose_one_label, choose_one_value);
								}
								// //////////////////////////////////////////////////////////////////////////////////////SELECTOR
								// END//////////////////////////////////////////////////////////////////////////////
								// //////////////////////////////////////////////////////////////////////////////////
								...
								for (int x = 0; x < columnitem.getLength(); x++) {
									...
									DataBaseLayer.setColModel(interface_id, part_id, col_head, col_name, col_index, col_width, col_editable, hidden, key,
											required, minval, maxval, dbcolumn, gridhidden, colinfluence, col_email, col_number, custom, custom_func,
									...
									for (int va = 0; va < validationsitem.getLength(); va++) {
										...
										for (int y = 0; y < validationitem.getLength(); y++) {
											...
											for (int z = 0; z < validationqueryitem.getLength(); z++) {
												...
												DataBaseLayer.InsertValidationDeleteitem(interface_id, part_id, validationtype, id_value, sql_value,
									...
									for (int va = 0; va < validationsitem.getLength(); va++) {
										...
										for (int y = 0; y < validationitem.getLength(); y++) {
											...
											for (int z = 0; z < validationqueryitem.getLength(); z++) {
												...
												String message = x1.getAttribute("message");
												String function_name = x1.getAttribute("classname");
												DataBaseLayer.InsertValidationModifyitem(interface_id, part_id, validationtype, id_value, sql_value,
														parameter_value, message, function_name);
								...
								DataBaseLayer.insertpart(interface_id, part_id, part_class, resize, border, cols, rows, scrolling, spacing, colspan,
										maxlength, size, tabindex, archieve, codebase, mayscript, loadurl, editurl, caption, sortname, sortorder,
										treedataremotefunction, onselectremotefunction, autocollapse, initialiseonload, gridhidden, gridnavbar,
										grid_multiselect, rownum, rowlist, dateformat, tree_lazynode, tree_tooltip, grid_multiboxonly, tree_parentquery,
										tree_childquery, tree_parameter, resetSearchOnClose, multiplesearch, customeditbutton, griddata, griddatatype);
							...
							for (int z = 0; z < part.getLength(); z++) {
								...
								if (classtype.equals("chart")) {
									...
									for (int chartlist = 0; chartlist < chartstructurelist.getLength(); chartlist++) {
										...
										DataBaseLayer.insertChart(interface_id, part_id, content_id, matric_title, description, X_axis_query, series1_query,
												series2_query, series3_query, legenddata1, legenddata2, legenddata3, chart_type, subtype, width, height,
												yaxis_label, color, transpose, stacked, chart_dimension, xaxis_label);
								...
								if (valuetype.equals("cdata")) {
									...
									DataBaseLayer.insertcontent(content_id, part_id, value, valuetype, interface_id, contentlocation, show_choose_one,
											choose_one_label, choose_one_value);
								}
							}
						}
						// ////////////////CONTENT//////////////////////////////
	...
	public static Pair<Boolean,String> uploadInterfaceFragment(String htmlgeneratepath, String attachmentname, String s7, String typecollection, String fsize,
					...
					if(isExist){
						...
						for (int s = 0; s < structure.getLength(); s++) {
							...
							for (int d = 0; d < part.getLength(); d++) {
								...
								for (int el = 0; el < elementitem.getLength(); el++) {
									...
									String emailmess = el1.getAttribute("emailmess");
									String element_size = el1.getAttribute("size");
									DataBaseLayer.InsertDBFormElement(interface_id, interface_id + "_" + part_id, element_id, element_class, element_type,
											element_key, tabindex, selectindex, modifyindex, insertindex, rows, cols, forlabel, required, minlength,
											maxlength, equalto, number, email, requiredmess, minlengthmess, maxlengthmess, equaltomess, numbermess,
											emailmess, element_size);
								}
								...
								for (int u = 0; u < selectoritem.getLength(); u++) {
									...
									// FOR DROPDOWN
									// END//////////////////////////////////////////////////////
									DataBaseLayer.addSelecetor(interface_id, selector_id, selector_class, domaintype, value, gridrefresh, influence,
											interface_id + "_" + part_id, contentid, behaviourid, show_choose_one, choose_one_label, choose_one_value);
								}
								// //////////////////////////////////////////////////////////////////////////////////////SELECTOR
								// END//////////////////////////////////////////////////////////////////////////////
								// //////////////////////////////////////////////////////////////////////////////////
								...
								for (int x = 0; x < columnitem.getLength(); x++) {
									...
									DataBaseLayer.setColModel(interface_id, interface_id + "_" + part_id, col_head, col_name, col_index, col_width,
											col_editable, hidden, key, required, minval, maxval, dbcolumn, gridhidden, colinfluence, col_email, col_number,
									...
									for (int va = 0; va < validationsitem.getLength(); va++) {
										...
										for (int y = 0; y < validationitem.getLength(); y++) {
											...
											for (int z = 0; z < validationqueryitem.getLength(); z++) {
												...
												String message = x1.getAttribute("message");
												String function_name = x1.getAttribute("classname");
												DataBaseLayer.InsertValidationDeleteitem(interface_id, interface_id + "_" + part_id, validationtype,
									...
									for (int va = 0; va < validationsitem.getLength(); va++) {
										...
										for (int y = 0; y < validationitem.getLength(); y++) {
											...
											for (int z = 0; z < validationqueryitem.getLength(); z++) {
												...
												String message = x1.getAttribute("message");
												String function_name = x1.getAttribute("classname");
												DataBaseLayer.InsertValidationAdditem(interface_id, interface_id + "_" + part_id, validationtype, id_value,
									...
									for (int va = 0; va < validationsitem.getLength(); va++) {
										...
										for (int y = 0; y < validationitem.getLength(); y++) {
											...
											for (int z = 0; z < validationqueryitem.getLength(); z++) {
												...
												String message = x1.getAttribute("message");
												String function_name = x1.getAttribute("classname");
												DataBaseLayer.InsertValidationModifyitem(interface_id, interface_id + "_" + part_id, validationtype,
														id_value, sql_value, parameter_value, message, function_name);
								...
								for (int x = 0; x < queryitem.getLength(); x++) {
									...
									String query_value = x1.getAttribute("value");
									String load_parameter = x1.getAttribute("parameter");
									DataBaseLayer.InsertQueryitem(interface_id, interface_id + "_" + part_id, query_value, load_parameter, ServerCacheGrid,
											ServerCacheKeyIncludeUserId);
								}
								// //////////////////////////////////////////////////////////////////////////////////
								// FOR DBGrid
								...
								String griddata = e1.getAttribute("data");
								String griddatatype = e1.getAttribute("datatype");
								DataBaseLayer.insertpart(interface_id, interface_id + "_" + part_id, part_class, resize, border, cols, rows, scrolling,
										spacing, colspan, maxlength, size, tabindex, archieve, codebase, mayscript, loadurl, editurl, caption, sortname,
										sortorder, treedataremotefunction, onselectremotefunction, autocollapse, initialiseonload, gridhidden, gridnavbar,
										grid_multiselect, rownum, rowlist, dateformat, tree_lazynode, tree_tooltip, grid_multiboxonly, tree_parentquery,
										tree_childquery, tree_parameter, resetSearchOnClose, multiplesearch, customeditbutton, griddata, griddatatype);
						...
						for (int a = 0; a < layout.getLength(); a++) {
							...
							for (int c = 0; c < part.getLength(); c++) {
								...
								DataBaseLayer.insertlayout(layout_id, interface_id + "_" + part_id, height, width, left, top, position, parent_id,
										interface_id);
							...
							for (int z = 0; z < part.getLength(); z++) {
								...
								if (classtype.equals("chart")) {
									...
									for (int chartlist = 0; chartlist < chartstructurelist.getLength(); chartlist++) {
										...
										DataBaseLayer.insertChart(interface_id, interface_id + "_" + part_id, content_id, matric_title, description,
												X_axis_query, series1_query, series2_query, series3_query, legenddata1, legenddata2, legenddata3, chart_type,
								...
								if (classtype.equals("report") || classtype.equals("reportwindow")) {
									...
									for (int parameters_node_list = 0; parameters_node_list < report_parameters_Node_list.getLength(); parameters_node_list++) {
										...
										for (int parameter_list = 0; parameter_list < report_parameter_list.getLength(); parameter_list++) {
											...
											DataBaseLayer.AddReportParameter(interface_id, interface_id + "_" + part_id, content_id, parameter_name,
													parameter_value, valuesourceitemname, parameter_value_type);
										}

									}
									DataBaseLayer.ReportContent(interface_id, interface_id + "_" + part_id, content_id, viewer_type, report_chooser,
											report_executer, rpt_file);
								}
								// //////////////////////////////////////////////////FOR
								// REPORT
								// ONLY/////////////////////////////////////////////////////////////////////////////////
								...
								if (classtype.equals("flashcomponent")) {
									...
									for (int parameters_node_list = 0; parameters_node_list < flashcomponent_Node_list.getLength(); parameters_node_list++) {
										...
										for (int parameter_list = 0; parameter_list < flashcomponent_parameter_list.getLength(); parameter_list++) {
											...
											String parameter_name = flashcomponent_parameter_element.getAttribute("name");
											String parameter_value = flashcomponent_parameter_element.getAttribute("value");
											DataBaseLayer.AddFlashParameter(interface_id, interface_id + "_" + part_id, content_id, parameter_name,
													parameter_value);
										}
								...
								if (valuetype.equals("cdata")) {
									...
									DataBaseLayer.insertcontent(content_id, interface_id + "_" + part_id, value, valuetype, interface_id, contentlocation,
						...
						for (int j = 0; j < resource.getLength(); j++) {
							...
							for (int i = 0; i < resourceitem.getLength(); i++) {
								...
								DataBaseLayer
								.insertresourceinterface(id, href, resource_path, type, keyvalue, interface_id, resourcelocation, loggedInUserId);
							}
						}
						// ////////////////RESOURCE//////////////////////////////
	...
	private static String uploadRoleXML(HttpServletRequest request,String interface_id, String attachmentname, String s7, String typecollection, String fsize) {
		String inFileName = attachmentname + s7;
		DOMParser parser2 = new DOMParser();
		String statusMessage="";
		try {
	...
	private static String uploadManifest(HttpServletRequest request,String interface_id, String attachmentname, String s7, String typecollection, String fsize) {
		String inFileName = attachmentname + s7;
		DOMParser parser2 = new DOMParser();
		String statusMessage="";
		try {
