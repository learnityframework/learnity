...
public class LayoutUploader {
	...
	public static void addlayout(HttpServletRequest request, HttpServletResponse response, String strCreatedBy, PrintWriter out1,
	...
	private static void uploadInterfaceCollection(String attachmentname, String s7, String typecollection, String fsize, HttpServletRequest request,
			...
			for (int ma = 0; ma < interface1.getLength(); ma++) {
				...
				if (f1.exists()) {
					...
					if (childtype.equals(INTERFACE_TYPE)) {
						uploadInterface(attachmentname, attachmentname + name + File.separator + name + File.separator, zip, childtype, childSize,
	...
	public static void uploadInterface(String htmlgeneratepath, String attachmentname, String s7, String typecollection, String fsize,
	...
	private static void uploadRoleXML(String interface_id, String attachmentname, String s7, String typecollection, String fsize) {
		String inFileName = attachmentname + s7;
		DOMParser parser2 = new DOMParser();
		try {
	...
	private static void uploadManifest(String interface_id, String attachmentname, String s7, String typecollection, String fsize) {
		String inFileName = attachmentname + s7;
		DOMParser parser2 = new DOMParser();
		try {
