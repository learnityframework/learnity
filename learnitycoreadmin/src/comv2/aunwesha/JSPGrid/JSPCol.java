...
public class JSPCol {
    ...
    void _mthdo(int i1, int j1) {
        ...
        for (int k1 = 0; k1 < j1; ++k1) {
            JSPCell jspcell = new JSPCell();
            jspcell.a(i1);
            jspcell._mthif(k1 + 1);
            this._fldnull.addElement(jspcell);
        }
        Object obj = null;
        this._fldchar = j1;
    }
    ...
    void a(int i1, int j1) {
        for (int k1 = 0; k1 < j1; ++k1) {
            JSPCell jspcell = new JSPCell();
            jspcell.a(i1);
            jspcell._mthif(this._fldchar + k1 + 1);
            this._fldnull.addElement(jspcell);
        }
        Object obj = null;
        this._fldchar+=j1;
    ...
    public JSPCell Cells(int i1) {
        return (JSPCell)this._fldnull.elementAt(i1);
    }
